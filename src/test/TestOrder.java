...
public class TestOrder {
    ...
    {
        Order order = new Order(null,1L,200, Timestamp.valueOf("2020-01-02 13:45:06.8"),null,"支付宝",2,"未支付","小明", "110","110@qq.com");
        ...
        InfoOfOrder infoOfOrder = orderService.createNewOrder(order,ticketsId,passengers);
